...
function PeruMap({ setPopupPosition }) {
  const svgSelected = useRef();

  const handleMouseLeave = () => {
    setPopupPosition();
  };

  const handlePopupPos = (e) => {
    if (e.clientY >= 700) {
      setPopupPosition({
  ...
  const handleDanceImgs = (dances) => {
    ...
    for (let i = 0; i < dances.length; i++) {
      const target = document.getElementById(dances[i]);
      target?.setAttribute(
        "style",
  ...
  const handle = ({ target }, { zoomToElement }) => {
    const regionSvg = target;
    zoomToElement(regionSvg);
    svgSelected.current = target;
  };

  return (
    <div className={`h-screen flex items-center relative`}>
      <div className="absolute bottom-0 -right-4 z-0 h-[25rem] w-72 spray" />
      <TransformWrapper initialScale={1}>
        {(utils) => (
          <>
            <Controls {...utils} />
            <TransformComponent {...utils}>
              <svg
                baseProfile="tiny"
                fill="transparent"
                height="800"
                ...
                className="[&>path]:hover:cursor-pointer z-10"
              >
                <defs>
                  <pattern
                    id="bg-image"
                  ...
                  >
                    <image
                      href="https://seturismo.pe/wp-content/uploads/2018/08/turismo-en-huanuco.jpg"
                      id="bg-image2"
                      x="0"
                      y="0"
                      width="100%"
                ...
                <path
                  ...
                  onClick={(e) => handle(e, utils)}
                  onMouseLeave={handleMouseLeave}
                  onMouseMove={(e) => handlePopupPos(e)}
                  onMouseEnter={() => {
                    handleDanceImgs(["Callao"]);
                  }}
                  onMouseOut={() => {
                    handleRemoveDance();
                  }}
                ...
                <path
                  ...
                  onMouseMove={(e) => handlePopupPos(e)}
                  onMouseEnter={() => {
                    handleDanceImgs(["danzadetijeras"]);
                  }}
                  onMouseOut={() => {
                    handleRemoveDance();
                  }}
                ...
                <path
                  ...
                  onMouseMove={(e) => handlePopupPos(e)}
                  onMouseEnter={() => {
                    handleDanceImgs(["wititi", "carnaval"]);
                  }}
                  onMouseOut={() => {
                    handleRemoveDance();
                  }}
                ...
                <path
                  ...
                  onMouseMove={(e) => handlePopupPos(e)}
                  onMouseEnter={() => {
                    handleDanceImgs(["diablada", "caporal", "diablada2"]);
                  }}
                  onMouseOut={() => {
                    handleRemoveDance();
                  }}
                ...
                <path
                  ...
                  onMouseMove={(e) => handlePopupPos(e)}
                  onMouseEnter={() => {
                    handleDanceImgs(["Lima Provincias"]);
                  }}
                  onMouseOut={() => {
                    handleRemoveDance();
                  }}
                ...
                <path
                  ...
                  onMouseMove={(e) => handlePopupPos(e)}
                  onMouseEnter={() => {
                    handleDanceImgs(["festejo", "negritos"]);
                  }}
                  onMouseOut={() => {
                    handleRemoveDance();
                  }}
...
const Controls = ({ zoomIn, zoomOut, resetTransform }) => (
  <div className="absolute top-7 z-50 flex flex-col bg-transparent space-y-2">
    <button
      className="rounded-md border border-white p-1 active:scale-95 group hover:bg-white"
      onClick={() => zoomIn(0.3)}
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
